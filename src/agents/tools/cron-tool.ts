...
DELIVERY top-level: {mode:"none|announce|webhook",strategy?:"heartbeat|direct",channel?,to?,threadId?,bestEffort?}
...
For sessionTarget="main", omitted strategy or "heartbeat" keeps the systemEvent heartbeat path. strategy="direct" captures the main-session assistant output and sends it to required channel + to without a second model call or message-tool requirement; payload may be systemEvent or agentTurn. Non-main targets do not support strategy.
