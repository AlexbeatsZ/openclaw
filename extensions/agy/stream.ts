...
export function readAgyPluginConfig(config?: OpenClawConfig): AgyPluginConfig {
  ...
  return {
    command: normalizeOptionalString(pluginConfig.command),
    args: readStringArray(pluginConfig.args),
    cwd: normalizeOptionalString(pluginConfig.cwd),
    ...
    modelArg: normalizeOptionalString(pluginConfig.modelArg),
    promptArg: normalizeOptionalString(pluginConfig.promptArg),
