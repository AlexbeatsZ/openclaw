...
export const en: TranslationMap = {
  ...
  newSession: {
    ...
    workspaceTitle: "Start a focused session",
    workspaceHint: "Choose the right context, then describe the outcome you want.",
    identityHint: "Your private assistant, ready on this Gateway.",
    draftRow: "New session",
    mode: "Mode",
    lifeMode: "Life",
    professionalMode: "Professional",
    lifeModeHint: "Personal context and memory",
    professionalModeHint: "Isolated work context",
    lifeModeDescription: "Uses the Life core with its own workspace, transcript, and memory.",
    professionalModeDescription:
      "Uses the isolated Professional core. Remote nodes and cloud workers are unavailable.",
    professionalTargetReset:
      "Switched to Professional. The remote target was reset to this Gateway; your draft was kept.",
    agent: "Agent",
    where: "Where",
  ...
  custodian: {
    ...
    subtitle: "Launch tasks, manage models, and check system status",
    assistantTitle: "System assistant",
    assistantHint: "Complete setup, diagnostics, and routine maintenance here.",
    exitSetup: "Exit setup",
    hatchDraft: "Wake up, my friend!",
    placeholder: "Message OpenClaw…",
    unavailablePlaceholder: "Setup assistant unavailable — use a quick action",
    ...
    emptyState: "Connecting to the system assistant…",
    inferenceUnavailableTitle: "The setup assistant is temporarily unavailable",
    inferenceUnavailableBody:
      "The current Agy CLI does not provide the tool-free inference mode required by the setup assistant. This does not prevent you from launching normal tasks. Start a task now or choose another inference service for setup.",
    quickActions: "Quick actions",
    quickStart: "Quick start",
    startTask: "Start a new task",
    startTaskHint:
      "Choose the Life or Professional core, organize the task in a widescreen workspace, and launch your agent.",
    openModelSetup: "Configure inference",
    modelSetupHint: "Change the model and provider used by the setup assistant",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      pageNotFound: "No wiki page found for {path}.",
      chatCount: "{label} · {count} chats",
      sensitiveCount: "{count} sensitive",
      signalCount: "{count} signals",
      importedCluster: "Imported chats clustered around {label}.",
      withheldCountOne: "{count} digest was withheld pending review.",
      withheldCountMany: "{count} digests were withheld pending review.",
      messageCount: "{count} messages",
      messageRoleCounts: "{users} user · {assistants} assistant",
      details: "Details",
      hideDetails: "Hide details",
      vault: "Vault",
      vaultBreakdown: "Full vault breakdown: {breakdown}.",
      selectedSection: "Selected section: {section}.",
      ...
      counts: {
        ...
        claimRow: {
          one: "{count} claim row",
          many: "{count} claim rows",
        },
        openQuestion: {
          one: "{count} open question",
          many: "{count} open questions",
        },
        contradiction: {
          one: "{count} contradiction",
          many: "{count} contradictions",
        },
      },
      kinds: {
        entity: "entity",
