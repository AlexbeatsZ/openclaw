...
<AccordionGroup>
  ...
  <Accordion title="Discovery and status">
    ...
    | `/mode [status\|life\|professional]` | Show or switch the isolated [conversation core](/concepts/conversation-cores). Chinese aliases `/mode 生活` and `/mode 工作` are supported |
